...
int32_t main()
{
    ...
    function<void ( int ) >kick = [&] ( int asdf ) {
        ll n,c;
        cin>>n;
        int ar[100+5],st[100+5];
        int cat[100+5]={0},tsb[100+5];
        int cdt[100+5],wt[100+5],idle[100+5],q[100+5];
        ...
        cout<<"cat   tsb   cdt   wt    idle  q"<<endl;
        for(int i=1; i<=n; i++)
        {
          //  cout<<
          f(cat[i]);
          f(tsb[i]);
          f(cdt[i]); f(wt[i]);f(idle[i]);
          f(q[i]);cout<<endl;
